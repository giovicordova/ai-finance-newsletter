Before starting, ensure you are on main:
...
3. Commit the new edition file(s) on main with message: `chore: Generated daily AI finance briefing for YYYY-MM-DD`. On Fridays the weekly archive at `editions/weekly/YYYY-Wnn.md` is part of the same commit.
